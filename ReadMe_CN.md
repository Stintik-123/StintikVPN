...
- [🚀 如何使用](#-如何使用)
- [📱 推荐的 VPN 客户端](#-推荐的-vpn-客户端)
- [📦 现成订阅](#-现成订阅)
- [🤖 Telegram 代理 (MTProto)](#-telegram-代理-mtproto)
- [⚠️ 重要警告](#️-重要警告)
- [💰 支持项目](#-支持项目)
...
1. 从"现成订阅"部分复制所需的链接。
2. 通过 **"添加订阅"** 或 **"从剪贴板导入"** 将其插入到您的 VPN 客户端中。
3. 更新列表 → 选择服务器 → 连接。
...
| **Android TV** | NekoBox (TV 版) | [NekoBox](https://github.com/MatsuriDayo/NekoBoxForAndroid/releases) |
...
<details>
<summary>🔓 点击展开可用的 Telegram 代理</summary>

| # | 服务器 | 端口 | 连接 |
|:---:|:---|:---:|:---:|
| *暂无活跃代理* – 请稍后再来或添加您自己的代理 |
...
> 所有配置均收集自公开来源。**性能不保证 100%** – 很大程度上取决于您的提供商和地区。  
> **禁止**将这些配置用于违反俄罗斯联邦法律的非法活动。  
> 项目创建者**不对您的行为负责**。通过使用这些链接，您确认自己不违反法律。

---

## 💰 支持项目

本项目依靠热情维持。如果您觉得它有用 – 在 GitHub 上给个 ⭐ 星标，这是免费的，但真的很有帮助。

**支持卡片：** `79960694715` (Ozon)
