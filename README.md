...
- [🤖 Telegram прокси](#-telegram-прокси-mtproto--socks5)
- [🔗 Зеркала проекта StintikVPN](#-зеркала-проекта-stintikvpn)
...
**Простыми словами если не работает SNI используйте CIDR, если не работает CIDR используйте SNI**
...
Обновите подписку в клиенте (кнопка «Обновить»). Попробуйте сменить протокол (VLESS Reality → Trojan) или сервер. Иногда помогает перезапуск клиента или смена Wi-Fi/мобильного интернета.

**2. Как часто обновляются конфиги?**  
Конфигурации обновляются ежедневно их создателями. Ссылки в README всегда ведут на актуальные версии.

**3. Когда нужно использовать белые списки?**  
Только когда ваш мобильный оператор (МТС, Билайн, Tele2 и др.) включил «белые списки» РКН — и обычные сайты перестали открываться.

**4. Какой клиент лучше всего для новичка?**  
**Hiddify** — самый удобный и понятный. Рекомендуется для Windows и Android. На iOS — **Streisand**.

**5. Что делать, если Telegram прокси не подключается?**  
Прокси часто умирают. Просто попробуйте следующий из списка. Они обновляются регулярно.

**6. Можно ли использовать одну подписку на нескольких устройствах?**  
Да, большинство подписок поддерживают одновременное подключение с нескольких устройств (зависит от конкретного сервера).

**7. Безопасно ли пользоваться этими конфигами?**  
Конфиги из открытых источников. Рекомендуется не передавать через них чувствительные данные (банковские приложения, важные аккаунты). Используйте на свой страх и риск.
...
## 💰 Поддержать проект
Поддержка и развитие StintikVPN тратит много времени и сил поэтому если хотите помочь проекту поставьте ⭐ звезду на репозиторий это бесплатно и сильно поможет проекту
