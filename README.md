...
## 💰 Поддержать проект
Поддержка и развитие StintikVPN тратит много времени и сил поэтому если хотите помочь проекту можете закинуть мне на покушать либо просто поставьте ⭐ звезду на репозиторий это бесплатно и сильно поможет проекту
